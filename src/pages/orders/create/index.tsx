    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl id="shipping_details" mb="4" isInvalid={!!formik.errors?.shipping_details}>
            <FormLabel>Shipping Details</FormLabel>
            <Input
              type="text"
              name="shipping_details"
              value={formik.values?.shipping_details}
              onChange={formik.handleChange}
            />
            {formik.errors.shipping_details && <FormErrorMessage>{formik.errors?.shipping_details}</FormErrorMessage>}
          </FormControl>
